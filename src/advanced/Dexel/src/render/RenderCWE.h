...
public:
    ...
    void drawWorkpieceDexelSurface(const CutterParm& cutterPara, const std::vector<Vector3Df>& CubeCenter, const std::vector<Vector3Df>& CubeNormals, const std::vector<float>& PointHeigth, float CubeSize);
    void drawWorkpieceDexelLine(const CutterParm& cutterPara, const std::vector<Vector3Df>& CubeCenter, const std::vector<Vector3Df>& CubeNormals, const std::vector<float>& PointHeigth, float CubeSize);

    void InitializeTessllationArray(const std::vector<Vector3Df>& vertices, const std::vector<Vector3Df>& normals, const std::vector<Vector3Df>& CutterPostions);

    void SetTessllationArray(const std::vector<Vector3Df>& vertices, const std::vector<Vector3Df>& normals, const std::vector<Vector3Df>& CutterPostions);

    void drawTessllation(const CutterParm& cutterPara, const std::vector<Vector3Df>& vertices, const std::vector<Vector3Df>& normals, const std::vector<Vector3Df>& CutterPostions);

    QVector3D BoxSize;
private:
    QOpenGLVertexArrayObject vaoWorkpiece;
    QOpenGLVertexArrayObject vaoCutter;
    QOpenGLVertexArrayObject vaoTessllation;
    ...
    QOpenGLBuffer vboWorkpieceDexelSurface;
    QOpenGLBuffer vboTessllation;
    ...
    QOpenGLShaderProgram* programWorkpieceDexelSurface;
    QOpenGLShaderProgram* programTessllation;
    QOpenGLShaderProgram* programWorkpieceDexelLine;

    bool isCutterInitialized = false;
    bool hasSetVertices = false;
    ...
    void initializeProgramWorkpieceDexelSurface();
    void initializeProgramTessllation();
