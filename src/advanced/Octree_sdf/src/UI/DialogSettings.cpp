    ...
    : QDialog(parent, flags)
{
    ...
    const bool use5axis = Settings::use5axis(); // 新增使用五轴的选择
    ...
    Parameter::getInstance()->setUse5axis(use5axis); // 新增使用五轴的选择
    ...
    checkBoxUse5axis = new QCheckBox(this); // 新增使用五轴的选择
    checkBoxUse5axis->setCheckState(use5axis ? Qt::Checked : Qt::Unchecked); // 新增使用五轴的选择
...
void DialogSettings::accept()
{
    ...
    const bool use5axis = checkBoxUse5axis->checkState() == Qt::Checked; // 新增使用五轴的选择
    ...
    Settings::setUse5axis(use5axis); // 新增使用五轴的选择
...
void DialogSettings::setupLayout()
{
    ...
    layout->addWidget(new QLabel(tr("Use 5axis:"), this), 7, 0); // 新增使用五轴的选择
    layout->addWidget(checkBoxUse5axis, 7, 1); // 新增使用五轴的选择
